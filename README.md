...
x86_64 boot planning starts at [`docs/os/X86_64_BOOT_SUPPORT_ROADMAP.md`](docs/os/X86_64_BOOT_SUPPORT_ROADMAP.md). It covers UEFI, BIOS, Libreboot/GRUB, VM validation, recovery USB paths, boot profile names, boot parameters, read-only detection, and future hardening work.
...
| Phase1 boot splash SVG | [`assets/phase1-splash.svg`](assets/phase1-splash.svg) |
...
| Edge | `v6.0.0` | Experimental development branch beyond stable. |
