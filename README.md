...
Stable is currently `v5.0.0`. The next development package line is `v6.0.0`.
...
Use stable release tags or release branches when you want the safest repository state. Use `v5.0.0` for the stable public representation. Use `v6.0.0` only for future development and experimental work.
