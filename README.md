...
<p align="center">
  <img alt="Stable" src="https://img.shields.io/badge/stable-v4.4.0-39ff88">
  <img alt="Previous stable" src="https://img.shields.io/badge/previous%20stable-v4.3.0-7f8cff">
  <img alt="Edge" src="https://img.shields.io/badge/edge-v5.0.0-00d8ff">
...
Stable is currently `v4.4.0`. The next development package line is `v5.0.0`.
...
Use stable release tags or release branches when you want the safest repository state. Use `v4.3.0` for the stable public representation. Use `v5.0.0` only for future development and experimental polish.
...
| --- | --- | --- |
| Stable | `v4.4.0` | Current stable line for release-qualified work. |
| Previous stable | `v4.3.0` | Preserved previous stable release point. |
| Edge | `v5.0.0` | Experimental development branch beyond stable. |
...
- Current edge version: `v5.0.0`
- Stable base: `base/v4.3.0`
