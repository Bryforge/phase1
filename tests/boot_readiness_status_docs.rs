...
fn boot_readiness_status_preserves_ladder() {
    ...
    for level in [
        ...
        "Local focused-suite pass record present",
        "B3",
        "VM boot validated",
...
fn boot_readiness_status_defines_b2_implementation_status() {
    ...
    for text in [
        ...
        "B2 local focused-suite validation has passed",
    ] {
...
fn boot_readiness_status_preserves_b2_completion_checklist() {
    ...
    for text in [
        ...
        "B2 focused test-suite checker script exists.",
...
fn boot_readiness_status_preserves_b3_completion_checklist() {
    ...
    for text in [
        ...
        "B3 OpenBSD serial marker limitation is documented.",
        "B3 OpenBSD serial marker limitation tests exist.",
...
fn boot_readiness_status_preserves_evidence_map() {
    ...
    for text in [
        ...
        "tests/b3_openbsd_serial_limitation_docs.rs",
...
fn boot_readiness_status_preserves_hardening_and_non_claims() {
    ...
    for text in [
        ...
        "B2 has an initial dry-run assembly script and local focused-suite pass record, but remains dry-run preview only",
