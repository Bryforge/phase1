...
const EDGE_VERSION: &str = "v7.0.1";
const EDGE_PACKAGE_VERSION: &str = "7.0.1";
const STABLE_VERSION: &str = "v6.0.0";
const STABLE_PACKAGE_VERSION: &str = "6.0.0";
const PREVIOUS_STABLE: &str = "v5.0.0";
const COMPATIBILITY_BASE: &str = "v3.6.0";
const EDGE_CHECKPOINT: &str = "docs/archive/checkpoints/DEVELOPMENT_CHECKPOINT_EDGE_7_0_1.md";
...
fn website_demo_reports_current_stable_track() {
    ...
    assert!(has_line(&js, "    \"stable: v6.0.0\","));
    assert!(has_line(&js, "    \"previous stable: v5.0.0\","));
    assert!(has_line(&js, "    \"next edge: v7.0.1\","));
...
fn release_facing_files() -> [&'static str; 3] {
    [
        "README.md",
        "docs/releases/RELEASE_v6.0.0.md",
        "site/site.js",
    ]
}
