...
check_references() {
  ...
  check_contains docs/base1/PRE_MOVE_CHECKLIST.md 'Base1 pre-move checklist'
  check_contains docs/base1/PRE_MOVE_CHECKLIST.md 'Required before any group move'
  ...
  check_contains scripts/base1-reorganization-verify.sh 'mode: read-only'
  check_contains scripts/base1-reorganization-verify.sh 'Base1 organization readiness'
  check_contains scripts/base1-reorganization-verify.sh 'scripts/base1-doc-integrity.sh'
  check_contains scripts/base1-reorganization-verify.sh 'scripts/base1-link-check.sh'
  check_contains scripts/base1-reorganization-verify.sh 'scripts/base1-test-inventory-verify.sh'
