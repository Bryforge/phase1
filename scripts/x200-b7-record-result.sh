...
#
# Usage examples:
#   sh scripts/x200-b7-record-result.sh phase1_tiny_initramfs_seen
#   sh scripts/x200-b7-record-result.sh linux16_command_returned
#   sh scripts/x200-b7-record-result.sh initrd16_command_returned
#
