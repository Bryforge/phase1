...
#
# Usage examples:
#   sh scripts/x200-b7-record-result.sh phase1_linux_libre_full_seen
#   sh scripts/x200-b7-record-result.sh phase1_boot_splash_seen
#   sh scripts/x200-b7-record-result.sh blocked_after_huge_initrd_load
#
