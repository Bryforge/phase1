...
#
# Usage examples:
#   sh scripts/x200-b7-record-result.sh phase1_seabios_grub_seen
#   sh scripts/x200-b7-record-result.sh seabios_usb_not_booting
#   sh scripts/x200-b7-record-result.sh phase1_mbr_bootsector_seen
#   sh scripts/x200-b7-record-result.sh blocked_after_seabios_payload
