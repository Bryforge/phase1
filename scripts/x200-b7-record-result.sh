...
#
# Usage examples:
#   sh scripts/x200-b7-record-result.sh phase1_kernel_keyboard_console_seen
#   sh scripts/x200-b7-record-result.sh phase1_kernel_framebuffer_seen
...
case "$RESULT" in
  phase1_kernel_keyboard_console_seen|phase1_kernel_framebuffer_seen|phase1_kernel_vga_console_seen|phase1_grub_console_seen|phase1_multiboot_kernel_seen|phase1_initramfs_shell|boot_started|reset_after_linux16_handoff|blocked_after_multiboot_load|blocked_after_initrd_load|blocked_after_kernel_load|phase1_marker_seen|blocked|failed) : ;;
  *)
    cat <<'USAGE'
Usage:
