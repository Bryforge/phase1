...
#
# Usage examples:
#   sh scripts/x200-b7-record-result.sh phase1_linux_libre_baseline_seen
#   sh scripts/x200-b7-record-result.sh linux16_command_returned
#   sh scripts/x200-b7-record-result.sh blocked_during_linux_libre_load
#
