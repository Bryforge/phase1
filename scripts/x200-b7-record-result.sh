...
#
# Usage examples:
#   sh scripts/x200-b7-record-result.sh phase1_universal_boot_matrix_seen
#   sh scripts/x200-b7-record-result.sh phase1_full_system_load_seen
#   sh scripts/x200-b7-record-result.sh reset_after_tiny_initramfs_boot
#
