...
#
# Usage examples:
#   sh scripts/x200-b7-record-result.sh phase1_japanese_utf8_ready
#   sh scripts/x200-b7-record-result.sh phase1_native_color_console_seen
...
Allowed results:
  ...
  phase1_boot_protocol_matrix_seen
