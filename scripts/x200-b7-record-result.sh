...
#
# Usage examples:
#   sh scripts/x200-b7-record-result.sh phase1_system_console_v2_seen
#   sh scripts/x200-b7-record-result.sh phase1_system_console_seen
#   sh scripts/x200-b7-record-result.sh phase1_seabios_multiboot_seen
#   sh scripts/x200-b7-record-result.sh blocked_after_seabios_multiboot_load
#
