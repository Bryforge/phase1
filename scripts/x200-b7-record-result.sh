...
#
# Usage examples:
#   sh scripts/x200-b7-record-result.sh phase1_crypto_evidence_seen
#   sh scripts/x200-b7-record-result.sh phase1_evidence_hash_manifest_seen
#   sh scripts/x200-b7-record-result.sh phase1_supervisor_plan_seen
#
