...
non-claims:
  ...
  OpenBSD distribution, install Base1, modify host boot settings, or validate physical hardware.
  It does not validate an installer, validate recovery, prove hardening,
