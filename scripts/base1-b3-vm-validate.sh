...
# delivery paths. It does not launch QEMU, fetch kernels, install Base1,
# mutate disks, validate hardware, validate recovery, prove hardening, or claim
# full B3 completion by itself.
