...
>
> **Validation:** Links to repository docs, tests, contribution guidelines, and documentation policy.
>
...
1. Read [`../../CONTRIBUTING.md`](../../CONTRIBUTING.md) for repository-wide contribution guidelines.
2. Read [`../README.md`](../README.md) for the documentation status model.
3. Read [`../MANUAL_ROADMAP.md`](../MANUAL_ROADMAP.md) for the full Codex structure.
4. Read [`DOCS_CONTRIBUTING.md`](DOCS_CONTRIBUTING.md) before preparing documentation PRs.
5. Read [`PR_CHECKLIST.md`](PR_CHECKLIST.md) before opening documentation PRs.
6. Read [`../security/DOCS_CLAIMS.md`](../security/DOCS_CLAIMS.md) before editing safety, Base1, recovery, installer, crypto, or host-tool docs.
7. Read [`../security/TRUST_MODEL.md`](../security/TRUST_MODEL.md) before adding or documenting host-backed behavior.
8. Use the existing repository tests as the source of truth for implemented behavior.
...
- secret handling;
- claims that use words such as secure, safe, hardened, bootable, installer-ready, recovery-complete, cryptographically complete, audited, certified, quantum-safe, hardware-validated, or daily-driver ready.

Review safety-sensitive documentation with [`../security/REVIEW_GUIDE.md`](../security/REVIEW_GUIDE.md).

## Contribution gates

Repository-wide contribution expectations live in [`../../CONTRIBUTING.md`](../../CONTRIBUTING.md).
...
For focused documentation work, run the relevant gate:
